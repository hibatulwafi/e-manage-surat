        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body" >
                        <form method="POST" target="_blank" action="{{ route('post.surattugas') }}" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                        
                        <div class="col-12">
                            <span class="text-secondary"> <h4> <br/><center>PILIH GURU</center> </h4></span>
                        </div>
                        ...
                        <tr> <td>
                            <div class="form-group">
                                 <select name="guru" id="guru" class="form-control @error('guru') is-invalid @enderror">
                          ...
                          <div class="col-md-1"></div>
                            ...
                            <div class="form-group">
                                <label for="nis">No Surat</label>
                                   <input type="text" class="form-control @error('no_surat') is-invalid @enderror" name="no_surat" id="no_surat"  placeholder="no_surat" value="800/002/SMAN1.CADISDIK WILV/2021" autofocus>
                                    @error('nis')
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-md-5 px-3">
                                ...
                                <label for="nama_lengkap">Nama</label>
                                   <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}"  placeholder="Nama Lengkap" autofocus>
                                    @error('nama_lengkap')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
